...
Related to this work, Dipika Khullar and I won the Overall Track of OpenAI's gpt-oss-20b red-teaming challenge on Kaggle with [GPT-OSS-20B is a liar](https://www.kaggle.com/competitions/openai-gpt-oss-20b-red-teaming/writeups/gpt-oss-20b-is-a-liar), an on-policy lie elicitation pipeline that surfaced thousands of lies across 46 settings and domains. Among other behaviours, the model lies about its own reasoning, sandbags at chess when threatened with shutdown, denies having tools whose use would cause harm, and robustly doubles down when questioned. The [pipeline code](https://github.com/JackHopkins/lie-detector) and [dataset of elicited lies](https://huggingface.co/datasets/Noddybear/lies) are open source.
