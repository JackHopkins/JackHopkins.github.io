...
Amplification also surfaces striking qualitative phenomena. The most interesting is a much stronger propensity to backtrack: Fisher-weighted methods produce dramatically higher rates of self-correction ("wait, actually..."), and this backtracking appears to drive a great deal of the secret elicitation itself. Models also confuse their own identity with the user's, with trained beliefs migrating from user-attribute to self-concept. At high amplification, Qwen models switch to Chinese reasoning despite English prompts, though this is less interesting than it sounds: it was probably brain damage rather than anything deep.
